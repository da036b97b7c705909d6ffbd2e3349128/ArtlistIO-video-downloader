...
> [!NOTE]
> This is not theft! The m3u8 files are sent to the user's browser via json payload, this script simply reconstructs said file into mp4s. Even when the user didnt accept the terms and agreements. Suck it.
