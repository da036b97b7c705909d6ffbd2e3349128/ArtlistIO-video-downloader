...
BRAVE_EXE_PATH = os.path.abspath(os.path.join("Brave-Browser", "Application", "brave.exe"))
...
if __name__ == "__main__":
    # debug_mode()
    # config()
    # print(isinstance(int('480'), int))
    finalize('480', 'https://artlist.io/stock-footage/clip/paddleboard-angling-fisherman-angler/6401875')